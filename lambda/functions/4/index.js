...
const Process = function (event, context, callback) {
  ...
  this.host = request.headers.host[0].value;
    ...
    return new Promise((resolve, reject) => {
      ...
      if (commandObject) {
        ...
        if (!width || !height) {
          ...
          // 小さすぎる画像の場合、拡大させた方が見やすくなるので、600以下は調整なしでリサイズする
        } else if (size > 600) {
            ...
            S3.headObject({
              ...
              if (err) {
                S3.putObject({
                  ...
                  this.redirect(prefix + (commandStr ? "-" + commandStr : "") + suffix.slice(0, -5) + ".webp", 600);
                });
              } else {
    ...
    if (1 === this.status) {
      ...
      return this.callback(null, {
        ...
        headers: {
          ...
          location: [{
            key: "Location",
            value: "https://" + ENV.HOST + "/error.svg"
          }]
        }
      });
    }
    ...
    if (1 === this.status) {
      ...
      return this.callback(null, {
        ...
        headers: {
          ...
          location: [{
            key: "Location",
            value: "https://" + ENV.HOST + "/" + redirectPathname
          }]
        }
      });
    }
